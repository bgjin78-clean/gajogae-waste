...
def related_reviews(current_slug):
    ...
    for region, slug, service in reviews:
        ...
        items.append(
            f'<a href="/reviews/{review_slug(slug, service)}.html">{region} {service} 후기</a>'
        )
...
def review_html(region, slug, service, index):
    ...
    desc = f"{region} {service} 작업후기입니다. 작업 전후 사진, 현장 상황, 폐기물처리 비용 기준, 상담 방법을 확인하실 수 있습니다."
  ...
  <main>
    ...
    <section class="section review-before-after">
      ...
      <p class="section-desc">
        작업 전 상태와 정리 후 모습을 함께 확인할 수 있도록 구성했습니다.
      </p>
      ...
      <div class="before-after-grid">
        ...
        <figure>
          ...
          <figcaption>폐기물 분류 전 상태</figcaption>
        </figure>
